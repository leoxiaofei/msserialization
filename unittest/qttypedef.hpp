...
public:
    ...
    bool operator == (const QStringType& rhs) const
    {
        return str == rhs.str;
    }
...
{ 
public:
    QScopedPointer<int> pI;
    QSharedPointer<Type2> pT2;
    QScopedPointer<Type3> pT3;
    QSharedPointer<TypeBase> pBT1;
    QSharedPointer<TypeBase> pBT2;
    QSharedPointer<TypeBase> pBT3;
...
public:
    ...
    std::pair<QString, int32_t> pStrN32;
    std::tuple<uint16_t, QString, float> tU16StrF;
...
{
public:
    QVector<int32_t> vecN32;
    QList<uint16_t> lsU16;

    std::deque<Type1> deqT1;

    QSet<float> stF;
    std::unordered_set<uint32_t> ustU32;
    std::unordered_multiset<QString> umstStrN8;

    QMap<QString, int8_t> mapStrN8;
    QMap<double, uint64_t> mapDN64;

    QHash<QString, Type2> hsStrT2;
    QHash<double, QString> hsDStr;

    std::unordered_multimap<QString, double> ummapStrD;
...
{
    return R"({"vecN32":[1,2,3,4],"lsU16":[5,6,7],"deqT1":[{"n8":0,"u8":0,"n16":0,"u16":0},{"n8":-1,"u8":1,"n16":-16,"u16":16},{"n8":-2,"u8":2,"n16":-32,"u16":32}],"stF":[8.100000381469727,9.199999809265137,10.300000190734863],"ustU32":[11,12,13,14],"umstStrN8":["15","16","16","17"],"mapStrN8":{"aaa":1,"bbb":2},"mapDN64":[[12.0,22],[13.0,33]],"hsStrT2":{"0":{"n8":0,"u8":0,"n32":0,"u32":0},"1":{"n8":-1,"u8":1,"n32":16,"u32":32},"2":{"n8":-2,"u8":2,"n32":32,"u32":64},"3":{"n8":-3,"u8":3,"n32":48,"u32":96},"4":{"n8":-4,"u8":4,"n32":64,"u32":128}},"hsDStr":[[21.0,"21"],[22.0,"22"]],"ummapStrD":[["aaa",1.1],["aaa",4.4],["bbb",2.2],["ccc",3.3]],"ummapDT3":[[1.1,{"n8":5,"u8":251,"n64":6,"u64":18446744073709551610,"ull":70000000000}],[3.3,{"n8":5,"u8":251,"n64":6,"u64":18446744073709551610,"ull":70000000000}],[3.3,{"n8":5,"u8":251,"n64":6,"u64":18446744073709551610,"ull":70000000000}],[2.2,{"n8":5,"u8":251,"n64":6,"u64":18446744073709551610,"ull":70000000000}]]})";
}
